        ...
        <div className="B1qt-content-container">
          <div className="B1qt-top">
            <div className="B1qt-headings">
              <Heading size="xl" width="70%" textAlign="left">
                {props.data.test_name}
              </Heading>
              <Button
                size="lg"
                onClick={() => playpause(levelName, setlevelName)}
              >
                கேள்வி பெயர்
              </Button>
            </div>
            <div className="B1qt-instructions">
              <HStack justifyContent="space-between" pr="10%">
                ...
                <Button onClick={() => playpause(ins, setins)}>
                  <FontAwesomeIcon icon={faPlay} size="sm" />
                </Button>
              </HStack>
              <Heading size="md" fontWeight="normal">
                படங்களில் கொடுக்கப்பட்டுள்ளபடி, கேட்கும் இரண்டு ஒலிகள்
                ஒன்ரேயென்றால், ஆம் குறியை அழுத்தவும். வேறு ஒலிகள் என்றால், இல்லை
                குறியை அழுத்தவும்.
              </Heading>
            </div>
            {location.pathname === "/TestB1/Level1" && (
              <div className="B1qt-image-box">
                <Heading size="lg">சித்திர குறிப்பு</Heading>
                <div className="B1qt-images">
                  <Image
                    src={props.data.p1}
                    border="2px solid rgb(169, 255, 100)"
                    borderRadius="20px"
                  />
                  <Image
                    src={props.data.p2}
          ...
          <div className="B1qt-bottom">
            <VStack
              width="100%"
              color="rgb(0, 111, 56)"
              border="3px solid rgb(1, 200, 100)"
              borderRadius="20px"
              p="3%"
            >
              <Heading pb="5%" color="rgb(1, 200, 100)">
                சோதனைகள்
              </Heading>
              <Box
                borderRadius="10px"
                backgroundColor="rgba(1, 200, 100, 0.432)"
                p={6}
              >
                <HStack>
                  <Heading size="md" fontWeight="normal" pb="15px">
                    <strong>சோதனை 1: </strong>ஒலிகளில் வேறுபாடு உள்ளதா?
                  </Heading>
                  <Button
                    onClick={() =>
                      audioPlaypause(setAns1, 1, setIsPlayDisabled1)
                    }
                    isDisabled={isPlayDisabled1}
                    shadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px"
                    bgColor="rgb(255, 239, 179)"
                    _hover={{ bgColor: "rgb(255, 220, 179)", shadow: "none" }}
                    borderRadius="20px"
                  >
                    <FontAwesomeIcon
                      icon={faPlay}
                      size="sm"
                      style={{ color: "rgb(1, 200, 100)" }}
                    />
                  </Button>
                </HStack>
                <RadioGroup
                  value={t1}
                  isDisabled={t1Disabler}
                ...
                >
                  <HStack justifyContent="center" spacing="40px">
                    <Radio
                      value="ஆம்"
                      onChange={(e) =>
                        handleChange(e, setT1, setT1Disabler, ans1)
                      }
                      colorScheme="whatsapp"
                    >
                      ஆம்
              ...
              >
                <HStack>
                  <Heading size="md" fontWeight="normal" pb="15px">
                    <strong>சோதனை 2: </strong>ஒலிகளில் வேறுபாடு உள்ளதா?
                  </Heading>
                  <Button
                    onClick={() =>
                      audioPlaypause(setAns2, 2, setIsPlayDisabled1)
                    }
                    isDisabled={isPlayDisabled1}
                    shadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px"
                    bgColor="rgb(255, 239, 179)"
                ...
                >
                  <HStack justifyContent="center" spacing="40px">
                    <Radio
                      value="ஆம்"
                      onChange={(e) =>
                        handleChange(e, setT2, setT2Disabler, ans2)
                      }
                      colorScheme="whatsapp"
                    >
                      ஆம்
              ...
              >
                <HStack>
                  <Heading size="md" fontWeight="normal" pb="15px">
                    <strong>சோதனை 3: </strong>ஒலிகளில் வேறுபாடு உள்ளதா?
                  </Heading>
                  <Button
                    onClick={() =>
                      audioPlaypause(setAns3, 3, setIsPlayDisabled1)
                    }
                    isDisabled={isPlayDisabled1}
                    shadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px"
                    bgColor="rgb(255, 239, 179)"
                ...
                >
                  <HStack justifyContent="center" spacing="40px">
                    <Radio
                      value="ஆம்"
                      onChange={(e) =>
                        handleChange(e, setT3, setT3Disabler, ans3)
                      }
                      colorScheme="whatsapp"
                    >
                      ஆம்
