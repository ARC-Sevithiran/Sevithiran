...
const QuestionTab = (props) => {
  ...
  const audioPlaypause = async(setAns,num) =>{
              ...
              <Heading pb="5%" color='rgb(1, 200, 100)'>சோதனைகள்</Heading>
                <Box  borderRadius='10px' backgroundColor='rgba(1, 200, 100, 0.432)' p={6}>
                  <HStack>
                    ...
                    <Button onClick={()=>audioPlaypause(setAns1,1)} shadow='rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px' bgColor='rgb(255, 239, 179)' _hover={{bgColor:'rgb(255, 220, 179)', shadow: 'none'}} borderRadius='20px' >
                ...
                <Box  borderRadius='10px' backgroundColor='rgba(1, 200, 100, 0.432)' p={6} >
                  <HStack>
                    ...
                    <Button onClick={()=>audioPlaypause(setAns2,2)} shadow='rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px' bgColor='rgb(255, 239, 179)' _hover={{bgColor:'rgb(255, 220, 179)', shadow: 'none'}} borderRadius='20px' >
                      <FontAwesomeIcon icon={faPlay} size="sm" style={{color: "rgb(1, 200, 100)",}} />
                    </Button>                    
                  </HStack>
                ...
                <Box  borderRadius='10px' backgroundColor='rgba(1, 200, 100, 0.432)' p={6}>
                  <HStack>
                    ...
                    <Button onClick={()=>audioPlaypause(setAns3,3)} shadow='rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px' bgColor='rgb(255, 239, 179)' _hover={{bgColor:'rgb(255, 220, 179)', shadow: 'none'}} borderRadius='20px' >
                      <FontAwesomeIcon icon={faPlay} size="sm" style={{color: "rgb(1, 200, 100)",}} />
                    </Button>
